<template>
    <svg role="presentation" :width="size" :height="size" aria-hidden="true" aria-label="Ses seviyesi düşük" id="volume-icon" viewBox="0 0 16 16" data-encore-id="icon" class="Svg-sc-ytk21e-0 gQUQL">
